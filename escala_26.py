...
if st.button('Cadastrar Funcionário'):
    if nome_funcionario and empresa_selecionada:
        ...
        # Identificar a qual tabela o funcionário deve ir (Turno 1, 2 ou 3)
        if turno_funcionario in ["C", "C1", "C2", "P", "P1", "P2", "F", "F1", "F2", "L", "L1"]:
            turno_alocado = 'Turno 1'
        elif turno_funcionario in ["B", "G", "G1", "SG", "SG1"]:
            turno_alocado = 'Turno 2'
        else:
            turno_alocado = 'Turno 3'

        empresas[empresa_selecionada]['funcionarios'][turno_alocado].append({
        ...
        salvar_empresas(empresas)
        st.success(f'Funcionário {nome_funcionario} cadastrado na empresa {empresa_selecionada} com o cargo {cargo_funcionario}, turno {turno_funcionario} e horário {horario_turno} no {turno_alocado}!')
...
for turno in ['Turno 1', 'Turno 2', 'Turno 3']:
    ...
    if empresa_selecionada in empresas and turno in empresas[empresa_selecionada]['funcionarios']:
        ...
        # Dividir os funcionários por cargo
        ...
        # Gerar escala para cada cargo no turno
        ...
        st.warning(f'Nenhum funcionário cadastrado para {turno} na empresa {empresa_selecionada}.')
